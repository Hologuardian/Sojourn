package holo.sojourn.world.moltar.features;
...
public class MapGenDeadTree extends WorldGenerator
{
    /**
    ...
    public MapGenDeadTree(boolean par1)
    {
        super(par1);
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(aint, aint1, Block.obsidian.blockID);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.placeBlockLine(aint, aint2, (byte)Block.obsidian.blockID);
            }
        }
    }
