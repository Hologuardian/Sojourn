...
public class BaseChunkManager extends WorldChunkManager
{
    ...
    protected BaseChunkManager(WorldType type)
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.addAll(Arrays.asList(type.getBiomesForWorldType()));
    }
