...
public class FungalMarshWorldProvider extends WorldProvider
{
    ...
    public void registerWorldChunkManager()
    {
        ...
        type.addNewBiome(BiomeGenBase.desert);
        
        type.addBiomeTransition(BiomeGenBase.extremeHills, BiomeGenBase.swampland, BiomeGenBase.river);
        type.addBiomeTransition(BiomeGenBase.extremeHills, BiomeGenBase.desert, BiomeGenBase.frozenRiver);
        type.addBiomeTransition(BiomeGenBase.swampland, BiomeGenBase.desert, BiomeGenBase.jungle);
...
//        this.worldChunkMgr = new WorldChunkManagerHell(SojournDimensionRegistry.fungalMarshBiome, 1.0F, 1.0F);
    ...
    {
        return new FungalMarshChunkProvider(this.worldObj, this.worldObj.getSeed(), false);
    }
