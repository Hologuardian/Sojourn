package holo.sojourn.teleporter;
...
public class AracoriaTeleporter extends Teleporter
{
    protected WorldServer myWorld;

    public AracoriaTeleporter(WorldServer var1)
    {
        super(var1);
        this.myWorld = var1;
    }
